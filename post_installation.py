...
def github_create_repo() -> None:
    body_json = {"name": "pyffle", "description": "placeholder"}
...
def github_create_secret(secret_name: str, secret_value: str) -> None:
    url_public_key = (
        ...
        "/pyffle/actions/secrets/public-key"
    )
    ...
    if r.status_code == 200:
        ...
        url_secret = (
            ...
            f"Stephen-RA-King"
            f"/pyffle/actions/secrets/{secret_name}"
        )
...
def readthedocs_create() -> None:
    body_json = {
        "name": "pyffle",
        "repository": {
            "url": "https://github.com/Stephen-RA-King" "/pyffle",
            "type": "git",
        },
...
def readthedocs_update() -> None:
    body_json = {"name": "pyffle", "default_branch": "main"}
...
def main() -> None:
    ...
    file_path = r"\pyffle\Lib\site-packages\semantic_release\repository.py"
